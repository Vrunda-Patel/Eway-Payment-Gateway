...
$('#make-payment').on('click', '#eway-dummy', function() {
  ...
  $('#make-payment').append('<script src="https://secure.ewaypayments.com/scripts/eCrypt.js" class="eway-paynow-button" data-publicapikey="epk-5C4E9F57-C730-40B6-9E20-022CA44347C3" data-amount="' + paymentValue + '" data-email="' + email + '" data-phone= "' + phone_no +'" data-currency="AUD"><\script>');
  //Click the button
  setTimeout(function() {
